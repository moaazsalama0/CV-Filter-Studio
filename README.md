...
**CV Filter Studio** is a high-performance, interactive desktop application designed for real-time classical Computer Vision experimentation. Built with a modular architecture, it allows users to apply, tune and visualize the mathematical foundations of image processing. All within a modern and dark-themed interface.

Note: The GUI was generated by an LLM. expect weird stuff
...
* **Mathematical Kernel Visualization**: Dynamic display of the underlying convolution matrices to bridge the gap between code and theory.
...
* **Granular Parameter Control**: Precision tuning of hyper-parameters (Sigma, Kernel Size, Thresholds) via custom-styled sliders.
